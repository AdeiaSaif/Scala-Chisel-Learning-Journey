...
class Top extends Module{
    ...
    dontTouch(immgen.io)
    val jlr= Module(new Jalr)
    dontTouch(jlr.io)

  
     // Jalr
    jlr.io.a:=reg.io.d1
    jlr.io.b:=immgen.io.out
    ...
    //inst mem
     ...
     reg.io.data:= Mux((cu.io.ins(6,0)==="b0110011".U) || (cu.io.ins(6,0)==="b0010011".U),alu.io.alu_out,
         /*load*/  Mux(cu.io.ins(6,0)==="b0000011".U, load.io.din,
                   ...
                   Mux(cu.io.ins(6,0)==="b1101111".U,((pc.io.out+4.U).asSInt),
                   Mux(cu.io.ins(6,0)==="b1100011".U,alu.io.alu_out,
                   Mux(cu.io.ins(6,0)==="b1100111".U,((pc.io.out).asSInt)+4.S,0.S)))))))
    ...
    Mux(instmem.io.dout(6,0)==="b1100111".U,  (jlr.io.out).asUInt,4.U)))


   // pc.io.op:=instmem.io.dout(6,0)
